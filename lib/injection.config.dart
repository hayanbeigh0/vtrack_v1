...
import 'package:vtrack_v1/domain/notifications/i_notification.dart' as _i15;
...
import 'package:vtrack_v1/infrastructure/core/dio_module.dart' as _i27;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i19.SearchUserBloc>(
        () => _i19.SearchUserBloc(gh<_i13.IUserRepository>()));
    gh.lazySingleton<_i20.Dio>(() => dioModule.dio(gh<_i4.AuthInterceptor>()));
    gh.factory<_i21.OrganisationFormBloc>(
        () => _i21.OrganisationFormBloc(gh<_i7.IOrganisationRepository>()));
    gh.factory<_i22.OrganisationCubit>(
        () => _i22.OrganisationCubit(gh<_i7.IOrganisationRepository>()));
    gh.factory<_i23.VehicleFormBloc>(
        () => _i23.VehicleFormBloc(gh<_i9.IVehicleRepository>()));
    gh.factory<_i24.VehicleCubit>(
        () => _i24.VehicleCubit(gh<_i9.IVehicleRepository>()));
    gh.factory<_i25.CurrentUserCubit>(
        () => _i25.CurrentUserCubit(gh<_i13.IUserRepository>()));
    return this;
  }
}
