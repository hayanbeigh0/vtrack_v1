...
import 'package:vtrack_v1/application/auth/auth_bloc/auth_bloc.dart' as _i17;
...
import 'package:vtrack_v1/application/vehicle/vehicle_form_bloc/vehicle_form_bloc.dart'
    as _i24;
import 'package:vtrack_v1/domain/auth/i_auth_facade.dart' as _i13;
...
import 'package:vtrack_v1/domain/user/i_user.dart' as _i15;
import 'package:vtrack_v1/domain/vehicle/i_vehicle.dart' as _i11;
import 'package:vtrack_v1/infrastructure/auth/auth_facade.dart' as _i14;
import 'package:vtrack_v1/infrastructure/core/auth_interceptor.dart' as _i4;
import 'package:vtrack_v1/infrastructure/core/dio_module.dart' as _i28;
...
import 'package:vtrack_v1/infrastructure/organisation/organisation_repository.dart'
    as _i8;
import 'package:vtrack_v1/infrastructure/user/user_repository.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.IVehicleRepository>(() => _i12.VehicleRepository());
    ...
    gh.factory<_i19.UserNotificationsCubit>(
        () => _i19.UserNotificationsCubit(gh<_i9.INotificationRepository>()));
    gh.factory<_i20.SearchUserBloc>(
        () => _i20.SearchUserBloc(gh<_i15.IUserRepository>()));
    gh.lazySingleton<_i21.Dio>(() => dioModule.dio(gh<_i4.AuthInterceptor>()));
    gh.factory<_i22.OrganisationFormBloc>(
        () => _i22.OrganisationFormBloc(gh<_i7.IOrganisationRepository>()));
    gh.factory<_i23.OrganisationCubit>(
        () => _i23.OrganisationCubit(gh<_i7.IOrganisationRepository>()));
    gh.factory<_i24.VehicleFormBloc>(
        () => _i24.VehicleFormBloc(gh<_i11.IVehicleRepository>()));
    gh.factory<_i25.VehicleCubit>(
        () => _i25.VehicleCubit(gh<_i11.IVehicleRepository>()));
    gh.factory<_i26.CurrentUserCubit>(
        () => _i26.CurrentUserCubit(gh<_i15.IUserRepository>()));
    return this;
  }
}
