...
import 'package:vtrack_v1/infrastructure/core/dio_module.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i17.SearchUserBloc>(
        () => _i17.SearchUserBloc(gh<_i13.IUserRepository>()));
    gh.lazySingleton<_i18.Dio>(() => dioModule.dio(gh<_i4.AuthInterceptor>()));
    gh.factory<_i19.OrganisationFormBloc>(
        () => _i19.OrganisationFormBloc(gh<_i7.IOrganisationRepository>()));
    gh.factory<_i20.OrganisationCubit>(
        () => _i20.OrganisationCubit(gh<_i7.IOrganisationRepository>()));
    gh.factory<_i21.VehicleFormBloc>(
        () => _i21.VehicleFormBloc(gh<_i9.IVehicleRepository>()));
    gh.factory<_i22.VehicleCubit>(
        () => _i22.VehicleCubit(gh<_i9.IVehicleRepository>()));
    gh.factory<_i23.CurrentUserCubit>(
        () => _i23.CurrentUserCubit(gh<_i13.IUserRepository>()));
    return this;
  }
}
