...
import 'package:vtrack_v1/presentation/core/utils/location_picker.dart';
...
class _CreateVehicleFormState extends State<CreateVehicleForm> {
  ...
  void onPickupLocationSelected(PickResult result, BuildContext context) {
